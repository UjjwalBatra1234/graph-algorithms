                ...
                switch (command.toUpperCase()) {
                    ...
                    case "U":
                        if (tokens.length == 4) {
                            ...
                            if (weight < 0) {
                                ...
                                float timeDifference = (float) (stopUTime - startUTime) / 1000000;
                                System.out.println("Update Edge Time: " + timeDifference);
                            }
                        } else {
                            System.err.println(lineNum + ": incorrect number of tokens.");
                        }
                    ...
                    case "RV":
                        if (tokens.length == 2) {
                            ...
                            float timeDifference =  ( (float)stopRVTime - startRVTime) / 1000000;

                            System.out.println("Remove Vertex Time: " + timeDifference);
                    ...
                    case "ON":
                        if (tokens.length == 3) {
                            ...
                            float timeDIfference  = (float) (stopONTime - startONTime) / 1000000;
                            System.out.println("Out Nearest Neighbours Time: " + timeDIfference);
                    ...
                    case "IN":
                        if (tokens.length == 3) {
                            ...
                            long stopINTime = System.nanoTime();
                            float timeDifference = (float) (stopINTime - startINTime) / 1000000;

                            System.out.println("In Nearest Neighbours Time: " + timeDifference);
